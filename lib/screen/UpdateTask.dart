...
class UpdateTaskState extends State<UpdateTask>
{
  ...
  Future<List> olddata;
  getsingledata(taskid) async
  {
    DatabaseHandler obj=new DatabaseHandler();
    olddata = obj.get_task_byid(taskid);
    olddata.then((value)  {
      print(value);
      _taskname.text = value[0]["task_name"].toString();
      _description.text = value[0]["description"].toString();
      _startdate.text= value[0]["start_date"].toString();
    });
  }
              ...
              children: [
                ...
                InkWell(
                  onTap: () async {
                    ...
                    DatabaseHandler obj = new DatabaseHandler();
                    int id = await obj.update_task(taskid,tasktitle,taskdesc,date);
                  ...
                  child: Container(
                    ...
                    child: Text("Update Task",style: TextStyle(color: Colors.white,fontSize: 18,fontWeight: FontWeight.w500)),
